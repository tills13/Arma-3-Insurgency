...
INS_fnc_recruitAI = {
	...
	if (leader group _caller != _caller) then {
        ...
        diag_log format ["%1 recruiting a %2", name _caller, _type];
...
TELAHQ_MENU_AID = _object addAction ["Teleport to <t color='#6775cf'>AHQ</t>", INS_fnc_teleport, [player, "AHQ"], 1.00, false, false, "", "alive AHQ"];
TELMHQ_MENU_AID = _object addAction ["Teleport to <t color='#6775cf'>MHQ</t>", INS_fnc_teleport, [player, "MHQ"], 1.00, false, false, "", "alive MHQ"];
REC_MENU_AID = _object addAction ["<t color='#6775cf'>Recruit AI</t>", FLAG_expand_menu, nil, 1.5, false, false];