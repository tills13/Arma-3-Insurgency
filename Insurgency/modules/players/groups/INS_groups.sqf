...
INS_groups_addActions = {
	...
	INS_groups_quitLead = player addAction["  Step Down as Group Lead", INS_groups_quitLead, nil, 1.05, false, false, "", "(count units group _this) > 1 && leader group _this == _this"];
	INS_groups_exitMenu = player addAction["  <t color='#ff6347'>Exit Groups Menu</t>", INS_groups_removeActions, nil, -1.04, false, true];	
};
